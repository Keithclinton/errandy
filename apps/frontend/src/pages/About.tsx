export default function About() {
  return (
    <article className="prose prose-sm mx-auto max-w-2xl space-y-4">
      ...
      <p className="text-sm">
        Errandspot connects people who need something done with people nearby who have the time, the skill, or
        both.
      </p>
      ...
      <p className="text-sm">
        Errandspot is built and run by a team based in Nairobi, for the community we're part of. Questions,
        feedback, or a task category we should add? Reach us at support@errandspot.com.
      </p>
    </article>
  );
}
